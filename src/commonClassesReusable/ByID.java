...
public class ByID extends BrowserSelection {
	...
	public static void SendKeys_After_Clearing_Previous_data_Using_ID(String finalid, String screenshotname,
			String entersomething) throws IOException, InterruptedException {
		try {
	...
	public static boolean Dropdown_Select(String finalxpath, String screenshotname, String ddl_value)
			throws IOException, InterruptedException {
		try {
			Dropdown_Select_Using_ID(finalxpath, screenshotname, Integer.parseInt(ddl_value));

		} catch (NumberFormatException nfe) {

			Dropdown_Select_Using_ID(finalxpath, screenshotname, (ddl_value));
			return false;
		}
		return true;
	}
	...
	public static void Dropdown_Select_Using_ID(String finalid, String screenshotname, String dropdown_value)
		...
		try {
			...
			log1.info("Not able to Select value from dropdown " + dropdown_value);
	...
	public static void Dropdown_Select_Using_ID(String finalxpath, String screenshotname, int index_value)
			throws IOException, InterruptedException {
		try {
			dynamicwait.WaitUntilElement(By.id(finalxpath));
			WebElement clickfn = driver.findElement(By.id(finalxpath));
			Jexecutor.highlightElement(clickfn);
			Select select = new Select(driver.findElement(By.id(finalxpath)));
