...
public class ByXpath extends BrowserSelection
{
	 ...
	 * @throws IOException 
	 */
	public static void Click_Using_Xpath(String finalxpath, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
	...
	public static void SendKeys_Without_Clearing_Previous_data_Using_Xpath(String finalxpath, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.xpath(finalxpath));
	...
	public static Boolean GetAttribute_Using_Xpath(String finalxpath, String screenshotname, String searchstring) throws IOException, InterruptedException 
	{
		Boolean temp1 = false;
	...
	public static void SendKeys_After_Clearing_Previous_data_Using_Xpath(String finalxpath, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.xpath(finalxpath));
	...
	public static String GetText_Using_Xpath(String finalxpath, String screenshotname) throws IOException, InterruptedException 
	{
	...
	public static Boolean IsDisplayed_After_Clearing_Previous_data_Using_Xpath(String finalxpath, String screenshotname) throws IOException, InterruptedException 
	{
		Boolean temp;
		try
		{
	...
	public static void Submit_Using_Xpath(String finalxpath, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.xpath(finalxpath));
	...
	public static void Dropdown_Select_Using_Xpath(String finalxpath, String screenshotname , int index_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.xpath(finalxpath));
	...
	public static void Dropdown_Select_Using_Xpath(String finalxpath, String screenshotname , String dropdown_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.xpath(finalxpath));
