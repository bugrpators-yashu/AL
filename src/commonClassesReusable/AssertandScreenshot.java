...
public class AssertandScreenshot  extends BrowserSelection
{
	...
	{
		System.out.println("contact assert");
			Thread.sleep(2000);
	...
	{
		System.out.println("admin assert");
			Thread.sleep(2000);
	...
	public static void alertScreenshot(String SSname) throws IOException, InterruptedException, HeadlessException, AWTException
	{
		
		BufferedImage image = new Robot().createScreenCapture(new Rectangle(Toolkit.getDefaultToolkit().getScreenSize()));
		ImageIO.write(image, "png", new File("Results\\"+ReadDataFromPropertiesFile.readProperty_CommonData("newfoldercreated")+"\\Screenshot\\"+SSname+".jpeg"));
		System.out.println("Screenshot has been generated for " +SSname);
	}
