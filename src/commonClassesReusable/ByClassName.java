...
public class ByClassName extends BrowserSelection
{
	 ...
	 * @throws IOException 
	 */
	public static void Click_Using_ClassName(String finalclassName, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalclassName));
		WebElement clickfn = driver.findElement(By.className(finalclassName));
	...
	public static void SendKeys_Without_Clearing_Previous_data_Using_ClassName(String finalclassName, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalclassName));
		WebElement sendkeysfn = driver.findElement(By.className(finalclassName));
	...
	public static Boolean GetAttribute_Using_ClassName(String finalclassName, String screenshotname, String searchstring) throws IOException, InterruptedException 
	{
		Boolean temp1 = false;
	...
	public static void SendKeys_After_Clearing_Previous_data_Using_ClassName(String finalclassName, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalclassName));
	...
	public static String GetText_Using_ClassName(String finalclassName, String screenshotname) throws IOException, InterruptedException 
	{
	...
	public static Boolean IsDisplayed_After_Clearing_Previous_data_Using_ClassName(String finalclassName, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		Boolean temp;
		try
		{
	...
	public static void Submit_Using_ClassName(String finalclassName, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalclassName));
	...
	{  
	  try  
	  {  
	      Dropdown_Select_Using_ClassName(finalxpath,screenshotname,Integer.parseInt(ddl_value));
	  }  
	  catch(NumberFormatException nfe)  
	  {
		 Dropdown_Select_Using_ClassName(finalxpath,screenshotname,(ddl_value));  
	    return false;  
	  }  
	  return true;  
	}
	...
	public static void Dropdown_Select_Using_ClassName(String finalclassName, String screenshotname, String dropdown_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalclassName));
		WebElement clickfn = driver.findElement(By.className(finalclassName));
		Jexecutor.highlightElement(clickfn);
		Select select = new Select(driver.findElement(By.className(finalclassName)));
	...
	public static void Dropdown_Select_Using_ClassName(String finalxpath, String screenshotname, int index_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.className(finalxpath));
		WebElement clickfn = driver.findElement(By.className(finalxpath));
		Jexecutor.highlightElement(clickfn);
		Select select = new Select(driver.findElement(By.className(finalxpath)));
