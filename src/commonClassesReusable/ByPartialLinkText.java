...
public class ByPartialLinkText extends BrowserSelection
{
	 ...
	 * @throws IOException 
	 */
	public static void Click_Using_PartialLinkText(String finalpartialLinkText, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalpartialLinkText));
		WebElement clickfn = driver.findElement(By.partialLinkText(finalpartialLinkText));
	...
	public static void SendKeys_Without_Clearing_Previous_data_Using_PartialLinkText(String finalpartialLinkText, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalpartialLinkText));
		WebElement sendkeysfn = driver.findElement(By.partialLinkText(finalpartialLinkText));
	...
	public static Boolean GetAttribute_Using_PartialLinkText(String finalpartialLinkText, String screenshotname, String searchstring) throws IOException, InterruptedException 
	{
		Boolean temp1 = false;
	...
	public static void SendKeys_After_Clearing_Previous_data_Using_PartialLinkText(String finalpartialLinkText, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalpartialLinkText));
	...
	public static String GetText_Using_PartialLinkText(String finalpartialLinkText, String screenshotname) throws IOException, InterruptedException 
	{
	...
	public static Boolean IsDisplayed_After_Clearing_Previous_data_Using_PartialLinkText(String finalpartialLinkText, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		Boolean temp;
		try
		{
	...
	public static void Submit_Using_PartialLinkText(String finalpartialLinkText, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalpartialLinkText));
	...
	{  
	  try  
	  {  
		  Dropdown_Select_PartialLinkText(finalxpath,screenshotname,Integer.parseInt(ddl_value));
	  }  
	  catch(NumberFormatException nfe)  
	  {
		  Dropdown_Select_PartialLinkText(finalxpath,screenshotname,(ddl_value));  
	    return false;  
	  }  
	  return true;  
	}
	...
	public static void Dropdown_Select_PartialLinkText(String finalxpath, String screenshotname, int dropdown_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalxpath));
		WebElement clickfn = driver.findElement(By.partialLinkText(finalxpath));
		Jexecutor.highlightElement(clickfn);
		Select select = new Select(driver.findElement(By.partialLinkText(finalxpath)));
		select.selectByIndex(dropdown_value);
		AssertandScreenshot.checkerroralertcomesandaccept(screenshotname);
		AssertandScreenshot.GenerateScreenshot(screenshotname);
		System.out.println(screenshotname);
		log1.info(screenshotname);
	...
	public static void Dropdown_Select_PartialLinkText(String finalxpath, String screenshotname, String dropdown_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.partialLinkText(finalxpath));
