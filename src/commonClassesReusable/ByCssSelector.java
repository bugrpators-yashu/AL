...
public class ByCssSelector extends BrowserSelection
{
	 ...
	 * @throws IOException 
	 */
	public static void Click_Using_CssSelector(String finalcssSelector, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalcssSelector));
		WebElement clickfn = driver.findElement(By.cssSelector(finalcssSelector));
	...
	public static void SendKeys_Without_Clearing_Previous_data_Using_CssSelector(String finalcssSelector, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalcssSelector));
		WebElement sendkeysfn = driver.findElement(By.cssSelector(finalcssSelector));
	...
	public static Boolean GetAttribute_Using_CssSelector(String finalcssSelector, String screenshotname, String searchstring) throws IOException, InterruptedException 
	{
		Boolean temp1 = false;
	...
	public static void SendKeys_After_Clearing_Previous_data_Using_CssSelector(String finalcssSelector, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalcssSelector));
	...
	public static String GetText_Using_CssSelector(String finalcssSelector, String screenshotname) throws IOException, InterruptedException 
	{
	...
	public static Boolean IsDisplayed_After_Clearing_Previous_data_Using_CssSelector(String finalcssSelector, String screenshotname, String entersomething) throws IOException, InterruptedException 
	{
		Boolean temp;
		try
		{
	...
	public static void Submit_Using_CssSelector(String finalcssSelector, String screenshotname) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalcssSelector));
	...
	{  
	  try  
	  {  
	      Dropdown_Select_Using_CssSelector(finalxpath,screenshotname,Integer.parseInt(ddl_value));
	  }  
	  catch(NumberFormatException nfe)  
	  {
		  Dropdown_Select_Using_CssSelector(finalxpath,screenshotname,(ddl_value));  
	    return false;  
	  }  
	  return true;  
	}
	...
	public static void Dropdown_Select_Using_CssSelector(String finalcssSelector, String screenshotname, String dropdown_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalcssSelector));
		WebElement clickfn = driver.findElement(By.cssSelector(finalcssSelector));
		Jexecutor.highlightElement(clickfn);
		Select select = new Select(driver.findElement(By.cssSelector(finalcssSelector)));
	...
	public static void Dropdown_Select_Using_CssSelector(String finalxpath, String screenshotname, int index_value) throws IOException, InterruptedException 
	{
		try
		{
		dynamicwait.WaitUntilElement(By.cssSelector(finalxpath));
		WebElement clickfn = driver.findElement(By.cssSelector(finalxpath));
		Jexecutor.highlightElement(clickfn);
		Select select = new Select(driver.findElement(By.cssSelector(finalxpath)));
