...
public class ReadDataFromPropertiesFile {
	...
	public static String testReadDataFromPropertiesFile_saasData(String varname) throws IOException
	{
		Properties properties = new Properties();
		FileInputStream fis = new FileInputStream(GlobalComponents.saasData);
		properties.load(fis);
		String varname1 = properties.getProperty(varname);
		return varname1;
